...
export const constantRoutes = [
    {path: '/Login', name: 'Login', component: () => import("@/views/Login")},
    {
        path: '/Layout', name: 'Layout', component: Layout, children: [
            ...
            {path: '/electricManager', name: 'ElectricManager', component: () => import("@/views/ElectricManager")},
            {path: '/waterManager', name: 'WaterManager', component: () => import("@/views/WaterManager")},
            {path: '/check', name: 'Check', component: () => import("@/views/Check")},
            //
